...
#: Nucleotide vocabulary. ``N`` (id 0) doubles as padding, unknown base and
#: the alignment gap marker used by deletions and insertion fillers.
VOCAB: Final[Dict[str, int]] = {"N": 0, "A": 1, "C": 2, "G": 3, "T": 4}
...
#: Real bases that the generator may sample. ``N`` is deliberately excluded:
#: it is a structural marker, not a base call.
...
class DataConfig:
    ...
    Attributes:
        ...
        mutation_rate: Per-reference-position probability of introducing a
            mutation. The three mutation kinds are then chosen uniformly.
