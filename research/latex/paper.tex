...
\begin{xltabular}{\linewidth}{ll>{\raggedright\arraybackslash}Xl>{\raggedright\arraybackslash}X>{\raggedright\arraybackslash}Xl>{\raggedright\arraybackslash}X}
...
\setlength{\tabcolsep}{3.2pt}
\rowcolors{2}{rowgrey}{white}
\begin{xltabular}{\linewidth}{>{\raggedright\arraybackslash}Xl>{\raggedright\arraybackslash}X}
...
\texttt{cascade.\allowbreak{}py} sha256 & \texttt{b0ee9f4b24fe06dc\ldots{}} & unchanged through v16--v20 (recomputed in audit) \\
\texttt{method\_\allowbreak{}c\_\allowbreak{}regression.\allowbreak{}py} sha256 & \texttt{b5cea1f1660eb472\ldots{}} & same \\
\bottomrule
\end{xltabular}
}
...
\emph{Decision rule.} Defined in the project devlog (devlog 13 \S{}3.4) and implemented in \texttt{bench\_\allowbreak{}v14\_\allowbreak{}crosschrom.\allowbreak{}classify}; there is no external registry, and whether it preceded the v13 analysis is not established. Per cell with $\ge$ 100 SNPs, and pooled:
...
\setlength{\tabcolsep}{3.2pt}
\rowcolors{2}{rowgrey}{white}
\begin{xltabular}{\linewidth}{llll>{\raggedright\arraybackslash}Xlll>{\raggedright\arraybackslash}X}
...
\setlength{\tabcolsep}{3.2pt}
\rowcolors{2}{rowgrey}{white}
\begin{xltabular}{\linewidth}{>{\raggedright\arraybackslash}Xrrrrrr}
\toprule
...
\setlength{\tabcolsep}{3.2pt}
\rowcolors{2}{rowgrey}{white}
\begin{xltabular}{\linewidth}{>{\raggedright\arraybackslash}Xrrr>{\raggedright\arraybackslash}X>{\raggedright\arraybackslash}X}
...
\setlength{\tabcolsep}{3.2pt}
\rowcolors{2}{rowgrey}{white}
\begin{xltabular}{\linewidth}{ll>{\raggedright\arraybackslash}Xl}
...
\setlength{\tabcolsep}{3.2pt}
\rowcolors{2}{rowgrey}{white}
\begin{xltabular}{\linewidth}{l>{\raggedright\arraybackslash}X>{\raggedright\arraybackslash}X>{\raggedright\arraybackslash}X>{\raggedright\arraybackslash}X}
...
\item \emph{Tests.} Original tests (a 12-category suite, 11 coordinate tests, "102/102") were lost; three replacements were written from scratch and are not the originals. Full suite as recorded in the freeze report (2026-09-20; not re-run for this draft): 490 passed, 0 failed, 1 skipped, 21 expected failures (the adversarial cases), 5 unexpected passes in the same category, 2 collection errors (\texttt{test\_\allowbreak{}bimamba.\allowbreak{}py}, \texttt{test\_\allowbreak{}providers.\allowbreak{}py}, missing \texttt{bimamba\_\allowbreak{}variant\_\allowbreak{}caller}, pre-existing).
\end{itemize}
...
Original tests lost; replacements are reconstructions; \texttt{test\_\allowbreak{}providers.\allowbreak{}py}, \texttt{test\_\allowbreak{}bimamba.\allowbreak{}py} do not collect & test-based support for the native backends \\
...
Code, devlogs and results are in the repository \texttt{AI\_\allowbreak{}DNA\_\allowbreak{}ANALYZER} (\url{https://github.com/Kramkost/AI_DNA_ANALYZER}). The repository is currently private \placeholder{[AUTHOR TO CONFIRM: make it public before submission, and archive a release with a DOI]}. The state described here is local commit \texttt{0ee6d16} on \texttt{main}, which tracks the native backends (\texttt{native/\allowbreak{}}), the \texttt{load\_\allowbreak{}reads} optimisation, the chr20 validation (\texttt{experimental/\allowbreak{}chr20\_\allowbreak{}validation/\allowbreak{}}, \texttt{results/\allowbreak{}bench\_\allowbreak{}v20/\allowbreak{}}, \texttt{bench\_\allowbreak{}v20\_\allowbreak{}chr20.\allowbreak{}py}), the tests and \texttt{research/\allowbreak{}}. That commit is not on the remote: local history was rewritten after the analyses and has diverged from \texttt{origin/\allowbreak{}main}, which was at \texttt{48dbedf} when checked, so it has to be reconciled before pushing. Because of the rewrite, commit ids recorded in the freeze manifests (for example base commit \texttt{a3d5761}) do not resolve in the current history; the SHA-256 hashes of the frozen files (\texttt{cascade.\allowbreak{}py} \texttt{b0ee9f4b24fe06dc\ldots{}}, unchanged) are the stable identifiers. Input data are public GIAB files; paths and SHA-256 checksums are in \texttt{experimental/\allowbreak{}stress\_\allowbreak{}test/\allowbreak{}HG005\_\allowbreak{}MANIFEST.\allowbreak{}json}, \texttt{research/\allowbreak{}REPRODUCIBILITY.\allowbreak{}md} and \texttt{experimental/\allowbreak{}chr20\_\allowbreak{}validation/\allowbreak{}FROZEN\_\allowbreak{}MANIFEST.\allowbreak{}json}. Regional BAMs are not redistributed. The HG005 post-fix raw artefacts and the original native-validation reports were lost with a wiped \texttt{/\allowbreak{}tmp} worktree on 2026-09-20 and are not independently reproducible. The chr20 run reproduced its own lost first run exactly. In \texttt{CLAIM\_\allowbreak{}EVIDENCE\_\allowbreak{}MAP.\allowbreak{}csv}, five HG005 rows earlier labelled \texttt{VERIFIED\_\allowbreak{}RAW} (rows 43, 45, 46, 48, 63) are now \texttt{RECORD\_\allowbreak{}ONLY\_\allowbreak{}RAW\_\allowbreak{}UNAVAILABLE}; their values are unchanged.

Environment: Python 3.14.3, pysam 0.24.0 (htslib 1.23.1), numpy 2.4.4, scipy 1.17.1, samtools/bcftools 1.23.1 [13], gcc 15.3.1, Docker 29.4.1, Fedora 43, Intel i7-6700, 31 GiB. No lockfile exists. Image digests: hap.py 0.3.15 \texttt{sha256:d63b963a6cb01b4830393b22369e7b91d298e4156dde353739e74e4cfa4f96d0}; DeepVariant 1.6.1 \texttt{sha256:ccab95548e6c3ec28c75232987f31209ff1392027d67732435ce1ba3d0b55c68}; Clair3 v1.0.10 \texttt{sha256:57cf5d20f2ee39c1b91493ad1fb5c1b9fa838691efce818c3139caa5e6c6b974}. The extension needs \texttt{native/\allowbreak{}build.\allowbreak{}sh} (Python headers and pysam's bundled htslib headers).
