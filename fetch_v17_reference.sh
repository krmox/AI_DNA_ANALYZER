#!/bin/bash
# bench_v17 reference acquisition. Same source and release as every existing
# data/reference/chr*_full.fa: Ensembl release-110 GRCh38 per-chromosome FASTA.
# The contig comes from select_v17_region.py Rule C17
# (results/bench_v17/region_selection.json) and is not edited by hand.
set -u
mkdir -p data/reference logs_v17
...
ls -l data/reference/chr17_full.fa*
