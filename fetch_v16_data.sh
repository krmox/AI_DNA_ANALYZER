#!/bin/bash
# bench_v16 data acquisition. Every byte here comes from a public GIAB URL and
...
# coordinates changed. Coordinates come from select_v16_region.py
# (results/bench_v16/region_selection.json) and are not edited by hand.
set -u
...
fetch chr13_representative chr13 70000000 73000000 > logs_v16/fetch_chr13.log 2>&1
